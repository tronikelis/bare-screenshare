...
pub const RAYLIB_VERSION_MINOR: u32 = 6;
pub const RAYLIB_VERSION_PATCH: u32 = 0;
pub const RAYLIB_VERSION: &[u8; 8] = b"5.6-dev\0";
...
pub const ShaderLocationIndex_SHADER_LOC_VERTEX_INSTANCE_TX: ShaderLocationIndex = 29;
